...
export async function getLast3MonthsPlayUser1(req, res) {
    ...
    const chargeCollection = db.collection(`bucket_60ab7235c03a2d002eb2f574`);

    let dateFilter1 = {
        $gte: new Date("04-01-2023 21:00:0"),
        $lt: new Date("04-24-2023 21:00:0")
    };

    // let dateFilter2 = {
    //     $gte: new Date("05-10-2023 21:00:0"),
    ...
    return res.status(200).send({ message: uniqueUsers1 })
}